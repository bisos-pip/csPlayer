...
- [[#audit-trailed-running-of-xus][Audit Trailed Running of XUs]]
...
* Audit Trailed Running of XUs

Running of XUs through csPlayers or through running auditTrail.cs involved the following choices:

- One Destintation
  - immediate
     - Foreground
       exitCode, stdout, stderr, logs and Results dir diplayed.


     - Background
       An instanceId is returned. Run Outcome Dir includes results

  - Scheduled
    - When to run it in background is specified
