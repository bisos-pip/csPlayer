...
(setq  b:py:cs:csuList
  (list
   "bisos.csPlayer.csPlayer_derived_csu"
   "bisos.csPlayer.csxuFps_csu"
 ))
#+END_SRC
#+RESULTS:
| bisos.csPlayer.csPlayer_derived_csu | bisos.csPlayer.csxuFps_csu |
#+end_org """
...
from bisos.csPlayer import csPlayer_derived_csu
from bisos.csPlayer import csxuFps_csu

csuList = [ 'bisos.csPlayer.csPlayer_derived_csu', 'bisos.csPlayer.csxuFps_csu', ]
...
***** [[elisp:(org-cycle)][| *CmndDesc:* | ]]  Conventional top level example.
        ...
        csPlayer_derived_csu.examples_csu().pyCmnd()
